$(function(){
    $(window).scroll(function() {
        ...
        if( (scroll + winheight) > (os + ht)){
        	$('.content_image_wrapper').css("top", img_stopheight);
        	$('.content_image_wrapper').css("position", "absolute");
        }
        else if((scroll + winheight) < (os + ht)){
        	$('.content_image_wrapper').css("top", "auto");
        	$('.content_image_wrapper').css("position", "fixed");
        }
    });
});